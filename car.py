...
class Cars:
    ...
    def __init__(self, parameters: Dict[Union[int, str], List[Union[int, float]]]):#, minimalize: List[bool]):
        ...
        self.minimalize = [False, True, False, False, True, True, False, False]
    ...
    def update_parameters(self):
        ...
        criteria = Ui_MainScreen.get_checked_boxes()

        self.criteria = [True if (elem in criteria for elem in ['moc', 'max_predk', 'pojemnosc silnika', 'pojemnosc_bag', 'przebieg',
                                                               'spalanie', 'cena']) else False]
